...
module "aks_cluster" {
  ...
  resource_group_name                     = "aks${random_string.default.result}"
  location                                = "canadacentral"
  cluster_name                            = "aks${random_string.default.result}"
  ...
  cluster_agent_pool_name                 = "aks${random_string.default.result}"
  cluster_agent_pool_count                = "1"
  cluster_agent_pool_vm_size              = "Standard_DS2_v2"
  cluster_agent_pool_vm_os_disk_gb_size   = "30"
  log_analytics_workspace_name            = "aks${random_string.default.result}"
