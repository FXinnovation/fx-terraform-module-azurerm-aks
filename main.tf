module "resource_group" {
  source = "github.com/FXinnovation/fx-terraform-module-azurerm-resource-group.git?ref=0.1.0"
...
module "log_analytics_workspace" {
  source = "github.com/FXinnovation/fx-terraform-module-azurerm-log-analytics-workspace.git?ref=0.1.0"
...
module "service_principal" {
  source = "github.com/FXinnovation/fx-terraform-module-azuread-service-principal.git?ref=1.0.5"
