...
module "log_analytics_workspace" {
  source = "git::ssh://git@github.com/FXinnovation/fx-terraform-module-azurerm-log-analytics-workspace.git?ref=0.1.0"
...
module "service_principal" {
  source = "git::ssh://git@github.com/FXinnovation/fx-terraform-module-azuread-service-principal.git?ref=1.0.5"
